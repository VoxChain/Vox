...
ADD contrib/simpleentrypoint.sh /usr/local/bin/simpleentrypoint.sh
RUN chmod +x /usr/local/bin/steemdentrypoint.sh
RUN chmod +x /usr/local/bin/simpleentrypoint.sh
CMD /usr/local/bin/simpleentrypoint.sh
